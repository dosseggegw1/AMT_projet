...
public class Article_Category_Id  implements Serializable {
    ...
    public int getFk_idCategory() { return fk_idCategory; }
    public void setFk_idCategory(int fk_idCategory) { this.fk_idCategory = fk_idCategory; }
    public int getFk_idArticle() { return fk_idArticle; }
    public void setFk_idArticle(int fk_idArticle) { this.fk_idArticle = fk_idArticle;}
